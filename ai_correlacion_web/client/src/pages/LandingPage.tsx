  ...
  return (
    <div className="min-h-svh bg-background text-foreground">
      ...
      <main className={cn("relative z-10 py-12 sm:py-16", landingShell)}>
        <section className="grid gap-10 lg:grid-cols-2 lg:items-center lg:gap-12 xl:gap-14 2xl:gap-16">
          <div className="space-y-6">
            ...
            <h1 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl lg:text-[2.35rem] lg:leading-[1.15]">
              Plataforma de análise e correlação de logs para a defesa
            </h1>
            <p className="max-w-xl text-base leading-relaxed text-muted-foreground sm:text-lg">
              Pipeline de{" "}
              <span className="text-foreground/90">redução de logs</span>,{" "}
              <span className="text-foreground/90">interpretação consolidada</span> e{" "}
              <span className="text-foreground/90">investigação</span> em lote. Monitore estados, exporte artefatos e
        ...
        <section className="mt-20 space-y-6">
          <div className="text-center space-y-2 sm:text-left">
            ...
            <h2 className="text-2xl font-bold text-foreground sm:text-3xl">O que o Contradef oferece</h2>
        ...
        <section className="mt-12 rounded-2xl border border-cyan-500/25 bg-gradient-to-r from-cyan-50/90 via-background to-muted/30 p-6 sm:p-8 dark:from-cyan-950/40 dark:via-slate-950/60 dark:to-slate-950/80">
          <h3 className="text-sm font-semibold text-cyan-800 dark:text-cyan-200/90">Arquitectura de processamento</h3>
      ...
      <footer className="relative z-10 border-t border-border bg-muted/30 py-6 dark:border-white/5 dark:bg-black/30">
        ...
        >
          <p className="font-mono text-[10px] sm:text-xs leading-relaxed text-muted-foreground">
